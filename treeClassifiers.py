    ...
    def _best_split(self, X, y, loss_type):
        ...
        for idx in range(self.n_features_):
            ...
            for i in range(1, m):
                ...
                if loss_type == 'entropy':
                    loss_left = sum(-(num_left[x] / i)*np.log2((num_left[x] / i)) -(1-(num_left[x] / i))*np.log2(1-(num_left[x] / i)) for x in range(self.n_classes_))
...
#Gini Models with different max_depths from 0 to 5
